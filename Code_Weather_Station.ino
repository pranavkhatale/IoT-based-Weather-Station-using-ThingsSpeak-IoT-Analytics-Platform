...
String apiKey = "NTIM1RXET6YVUVWF";     //  Enter your Write API key from ThingSpeak IoT Analytics Cloud platform.

const char *ssid =  "DLinkWiFi";     // Replace with your Wi-Fi ssid.
const char *pass =  "Pass@123"; // // Replace with your Wi-Fi wpa2 key.
